...
const englishOverviewCopy = {
  ...
  reviewItems: {
    ...
    slashCommandsDescription: "Command files found outside Skill Manager, changed, or missing need a decision.",
...
export const overviewCopy = {
  ...
  "zh-CN": {
    ...
    reviewItems: {
      ...
      slashCommandsDescription: "在 Skill Manager 之外发现、已变更或缺失的 command 文件需要确认。",
