      ...
      <div className="skill-detail__chrome">
        <div className="skill-detail__header">
          <div className="skill-detail__heading-block">
            ...
            <span className="skill-detail__skeleton skill-detail__skeleton--title" aria-hidden="true" />
            <span className="skill-detail__skeleton skill-detail__skeleton--subtitle" aria-hidden="true" />
          </div>
          <div className="skill-detail__header-actions">
            <span className="skill-detail__loading-chip">Loading</span>
