...
class ReadModelService:
    ...
    def from_environment(
        ...
        *,
        ...
        store = SharedStore(paths.shared_store_root, manifest_path=paths.shared_store_manifest)
        active_support_store = support_store or HarnessSupportStore(paths.settings_path)
