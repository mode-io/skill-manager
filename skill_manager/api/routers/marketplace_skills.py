...
def search_marketplace(
    ...
    try:
        return container.skills_marketplace_queries.search_page(q, limit=limit, offset=offset)
...
def install_marketplace_skill(
    ...
    return container.skills_marketplace_installs.install_skill(body.install_token)
